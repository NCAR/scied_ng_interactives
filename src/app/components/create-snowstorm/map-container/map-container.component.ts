...
export class MapContainerComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar, private reloadService: ReloadService){
  ...
  ngOnInit() {
    this.subscription = this.reloadService.getReloadEmitter()
      .subscribe(value => {this.initialize();});
  }
  ...
  //Map Backgrounds
  this.mb1 = 'active';
  this.mb2 = ''; //includes and deactivates border on drop zones (dashed circles).
  ...
  //Temp Selections
  this.selectedTempNorth = '';
  this.selectedTempSouth = '';

  //Moisture Selection
  this.selectedMoistDirection = '';
  this.northArrowState = '';
  this.southArrowState = '';

  //Stage 1 Dynamic Content Displays
  this.hps = 'High Pressure System:';
  this.lps = 'Low Pressure System:';
  this.proceedVisibility = 'hidden';
  this.stageOneContent = '';

  //Stage 2 Dynamic Content Displays
  this.northTempSelect = 'hidden';
  this.southTempSelect = 'hidden';
  this.procceedVisibilityTwo = 'hidden';

  //Stage 3 Dynamic Content Displays
  this.visibilityThree = 'hidden';
  this.sfa1 = '';
  this.sfa2 = '';
  this.sfa3 = '';
  this.sfa4 = '';
  ...
  //Snackbar Messages
  this.noDataMessage = "You must place the L and H to proceed.";
  this.reverseDataMessage = "Not quite. Reverse the pieces and press Go";
  this.successDataMessage = "Great! For an upslope snow storm, high pressure is in the north and low pressure is in the south."

  this.selectTempMessage = "You must select Colder or Warmer from the North, Colder or Warmer from the South, and one arrow showing the direct of moisture to proceed."

  this.ccnMessage = "You're right about the cold air from the north. But there isn't enough moisture in that air for snow. Plus, cold air from the south wouldn't lead to a big snow storm. Try again.";
  this.ccsMessage = "You're right about the moisture source. But you also need some warm air to help form a big snow storm. Try again.";
  this.wwnMessage = "You're right about the warm air in the south. But you need some cold air to produce snow and more moisture. There isn't enough moisture in the north. Try again.";
  this.wwsMessage = "You're right about the moisture source. But you need cold air to produce snow. Try again.";

  this.wcnMessage = "Warm, moist air doesn't come from the north in the northern hemisphere. And air from the south wouldn't be cold enough for snow. Try again";
  this.wcsMessage = "You're right about the moisture source. But warm air in the north and cold air in the south wouldn't create a snow storm. Try again";

  this.cwnMessage = "You're right about the temperatures but you need more moisture. There isn't enough in the north. Try again.";
  this.cwsMessage = "Nice job! You chose the right ingredients and made an upslope snow storm.";

  //Snackbar Messages Array (size:11)
  this.messageArray = [this.noDataMessage, this.reverseDataMessage, this.successDataMessage, this.selectTempMessage, this.ccnMessage, this.ccsMessage, this.wwnMessage, this.wwsMessage, this.wcnMessage, this.wcsMessage, this.cwnMessage, this.cwsMessage ];
